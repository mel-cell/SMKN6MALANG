        ...
        <div className="container mx-auto px-16 relative z-10 h-full flex flex-col justify-end pb-16 text-white">
          <div className="hero-content">
            ...
            <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-4">
              JURNALISTIK <span className="text-blue-400">SEKOLAH</span>
            </h1>
            <p className="text-xl text-gray-200 max-w-2xl">
              Menulis berita, menyuarakan aspirasi. Membentuk karakter kritis
              dan kreatif.
            </p>
          </div>
        </div>
            ...
            <div className="lg:col-span-2 space-y-10">
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Jurnalistik melatih siswa dalam keterampilan menulis,
                  fotografi jurnalistik, dan reportase. Kami mengelola majalah
                  dinding, website berita sekolah, dan media sosial sekolah.
                </p>
              </div>

              <div>
                <h2 className="text-3xl font-bold mb-6 text-blue-950 flex items-center gap-3">
                  <Trophy className="w-8 h-8 text-blue-600" /> Prestasi Terbaru
                </h2>
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    "Juara Lomba Menulis Artikel (Menyusul)",
                    "Finalis Fotografi Jurnalistik (Menyusul)",
                    "Best Magazine Layout (Menyusul)",
                    "Kontributor Berita Terbaik (Menyusul)",
                  ].map((item, i) => (
                    <div
                      key={i}
              ...
              <Card className="border-blue-200 shadow-lg shadow-blue-100/50">
                <CardContent className="p-6 space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-lg">Jadwal Redaksi</h4>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Ruang Jurnalistik</p>
                    </div>
                  </div>
