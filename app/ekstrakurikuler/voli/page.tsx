        ...
        <div className="container mx-auto px-16 relative z-10 h-full flex flex-col justify-end pb-16 text-white">
          <div className="hero-content">
            ...
            <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-4">
              VOLI <span className="text-blue-500">BALL</span>
            </h1>
            <p className="text-xl text-gray-200 max-w-2xl">
              Smash Hard, Block Strong. Tim voli yang solid dan berprestasi.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="lg:col-span-2 space-y-10">
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Ekstrakurikuler Voli melatih kerjasama tim, ketangkasan, dan
                  fisik yang kuat. Kami rutin mengadakan sparring partner dan
                  mengikuti kompetisi tingkat pelajar.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    "Juara MKKS (Menyusul)",
                    "Juara Undangan (Menyusul)",
                    "Tim Fairplay (Menyusul)",
                    "Best Setter (Menyusul)",
                  ].map((item, i) => (
                    <div
                      key={i}
                ...
                <CardContent className="p-6 space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Senin & Rabu</p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Lapangan Voli</p>
                    </div>
                  </div>
