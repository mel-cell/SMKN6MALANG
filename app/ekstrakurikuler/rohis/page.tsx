...
export default function RohisPage() {
        ...
        <div className="container mx-auto px-16 relative z-10 h-full flex flex-col justify-end pb-16 text-white">
          <div className="hero-content">
            ...
            <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-4">
              ROHIS <span className="text-emerald-400">ISLAM</span>
            </h1>
            <p className="text-xl text-gray-200 max-w-2xl">
              Membentuk generasi muda yang beriman, bertaqwa, dan berakhlak
              mulia.
            </p>
          </div>
        </div>
            ...
            <div className="lg:col-span-2 space-y-10">
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Rohis (Rohani Islam) adalah wadah bagi siswa muslim SMKN 6
                  Malang untuk memperdalam ilmu agama, mempererat ukhuwah
                  islamiyah, dan melakukan kegiatan positif yang bermanfaat bagi
              ...
              <div>
                <h2 className="text-3xl font-bold mb-6 text-emerald-950 flex items-center gap-3">
                  <Trophy className="w-8 h-8 text-emerald-600" /> Kegiatan &
                  Prestasi
                </h2>
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    ...
                    "Baksoos & Santunan",
                    "Lomba MTQ Tingkat Kota (Menyusul)",
                  ].map((item, i) => (
                    <div
                      key={i}
              ...
              <Card className="border-emerald-200 shadow-lg shadow-emerald-100/50">
                <CardContent className="p-6 space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-lg">Jadwal Kajian</h4>
                      <p className="text-muted-foreground">Jumat & Sabtu</p>
