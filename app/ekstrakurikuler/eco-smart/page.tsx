        ...
        <div className="container mx-auto px-16 relative z-10 h-full flex flex-col justify-end pb-16 text-white">
          <div className="hero-content">
            ...
            <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-4">
              ECO <span className="text-green-400">SMART</span>
            </h1>
            <p className="text-xl text-gray-200 max-w-2xl">
              Cintai bumi, lestarikan alam. Generasi hijau untuk masa depan yang
              berkelanjutan.
            </p>
          </div>
        </div>
            ...
            <div className="lg:col-span-2 space-y-10">
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Eco Smart mengajak siswa peduli terhadap lingkungan. Kegiatan
                  kami meliputi daur ulang (recycle), penghijauan, komposting,
                  dan kampanye sekolah sehat & bersih (Adiwiyata).
                </p>
              </div>

              <div>
                <h2 className="text-3xl font-bold mb-6 text-green-950 flex items-center gap-3">
                  <Trophy className="w-8 h-8 text-green-600" /> Program &
                  Prestasi
                </h2>
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    "Sekolah Adiwiyata Mandiri",
                    "Juara Daur Ulang Kreatif (Menyusul)",
                    "Program Bank Sampah",
                    "Kampanye Zero Waste",
                  ].map((item, i) => (
                    <div
              ...
              <Card className="border-green-200 shadow-lg shadow-green-100/50">
                <CardContent className="p-6 space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-lg">Jadwal Kegiatan</h4>
