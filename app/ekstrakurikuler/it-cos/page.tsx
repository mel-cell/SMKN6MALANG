...
export default function ITCosPage() {
        ...
        <div className="container mx-auto px-16 relative z-10 h-full flex flex-col justify-end pb-16 text-white">
          <div className="hero-content">
            ...
            <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-4">
              IT <span className="text-blue-400">COS</span>
            </h1>
            <p className="text-xl text-gray-200 max-w-2xl">
              Community of Science and Technology. Mengembangkan skill coding,
              networking, dan teknologi digital.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="lg:col-span-2 space-y-10">
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  IT Cos adalah komunitas pecinta teknologi di SMKN 6 Malang.
                  Kami belajar pemrograman (web/mobile), pengelolaan jaringan,
                  IoT, dan hardware.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    "Juara LKS Web Design (Menyusul)",
                    "Finalis Hacking Contest (Menyusul)",
                    "Karya App Terbaik (Menyusul)",
                    "Sertifikasi Mikrotik (Menyusul)",
                  ].map((item, i) => (
                    <div
                      key={i}
                ...
                <CardContent className="p-6 space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Lab Komputer</p>
                    </div>
                  </div>
