        ...
        <div className="container mx-auto px-16 relative z-10 h-full flex flex-col justify-end pb-16 text-white">
          <div className="hero-content">
            ...
            <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-4">
              SEPAK <span className="text-green-500">BOLA</span>
            </h1>
            <p className="text-xl text-gray-200 max-w-2xl">
              Fair Play, Teamwork, Glory. Mengembangkan bakat sepak bola siswa
            ...
            <div className="lg:col-span-2 space-y-10">
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Ekstrakurikuler Sepak Bola adalah salah satu ekskul favorit di
                  SMKN 6 Malang. Kami rutin berlatih fisik, taktik, dan strategi
                  permainan, serta aktif mengikuti liga pelajar.
                </p>
              </div>

              <div>
                <h2 className="text-3xl font-bold mb-6 text-green-950 flex items-center gap-3">
                  <Trophy className="w-8 h-8 text-green-600" /> Prestasi Terbaru
                </h2>
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    "Juara Liga Pelajar (Menyusul)",
                    "Runner Up Cup (Menyusul)",
                    "Best Goalkeeper (Menyusul)",
                    "Tim Fairplay (Menyusul)",
                  ].map((item, i) => (
                    <div
                      key={i}
                ...
                <CardContent className="p-6 space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Selasa & Jumat</p>
